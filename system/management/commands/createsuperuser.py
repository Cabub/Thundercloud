...
from django.contrib.auth.management.commands.createsuperuser import (
    Command as CreateSuperUserCommand, DEFAULT_DB_ALIAS,
    PASSWORD_FIELD, NotRunningInTTYException
)
from system.cryptography import generate_backup_passphrase
...
class Command(CreateSuperUserCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write('Backup Passphrase: {}'.format(
                backup_passphrase.decode()
            ))
            user_data['backup_passphrase'] = backup_passphrase
